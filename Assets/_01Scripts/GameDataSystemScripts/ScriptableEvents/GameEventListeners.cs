...
namespace DataSystem
{
    ...
    [System.Serializable]
    public class EventInteractable : UnityEvent<IInterActable> { }
    ...
    public class GameEventListeners : MonoBehaviour
    {
        ...
        public EventInteractable OnRaiseInteractable;
        ...
        public void RaiseInteractable(IInterActable interactable)
        {
            OnRaiseInteractable?.Invoke(interactable);
        }
